...
const Hero: React.FC = () => {
  return (
    <div className="relative bg-gradient-to-br from-primary to-primary-light text-white overflow-visible min-h-[650px] md:min-h-[700px] lg:min-h-[800px] xl:min-h-[900px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-in relative z-30" style={{ animationDelay: '0.6s' }}>
              ...
              <Button 
                asChild 
                variant="outline" 
                className="bg-white/10 border-white text-white hover:bg-white hover:text-primary transition-colors relative z-30"
              >
          ...
          <div className="order-1 md:order-2 flex justify-center md:justify-end animate-bounce-in relative z-30">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden" style={{ zIndex: 0 }}>
